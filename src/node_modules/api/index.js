    ...
    return new Promise( (resolve, reject) => {
        ...
        function transform(ph) {
            ...
            for (let key in ph) {
                ...
                data[id].categoryId = ph[key]['gsx$categoryid']['$t'];
...
// export const fetchPhones = axios.get('https://spreadsheets.google.com/feeds/list/14TLc0l5UugaJjcS_Ch8OCCRjiJ5yDAI2KtrwAoSseDQ/od6/public/values?alt=json')
